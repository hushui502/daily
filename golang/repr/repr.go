...
// Option modifies the default behaviour of a Printer
...
func extractOptions(vals ...interface{}) (args []interface{}, options []Option) {
	for _, v := range vals {
		if o, ok := v.(Option); ok {
