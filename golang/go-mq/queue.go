...
func newQueue(name string, connectionName string, queuesKey string, redisClient RedisClient, errChan chan<- error) *redisQueue {
...
// SetPushQueue sets a push queue. In the consumer function you can call delivery.Push().
