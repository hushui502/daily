...
type ValidateOpts struct {
	// Digits as part of the input. Default to 6
	Digits otp.Digits
	// Algorithm to use for HMAC. Defalut to SHA1
...
func GenerateCodeCustom(secret string, counter uint64, opts ValidateOpts) (passcode string, err error) {
	...
	// The stdEncoding expected a dictionary of only upper case letters.
...
type GenerateOpts struct {
	...
	Secret []byte
	// Digits to request. Default to 6.
	Digits otp.Digits
