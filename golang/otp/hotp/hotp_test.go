...
func TestGenerate(t *testing.T) {
	k, err := Generate(GenerateOpts{
		Issuer:      "google",
		AccountName: "wayne@google.com",
	})
	require.NoError(t, err, "generate basic TOTP")
	require.Equal(t, "google", k.Issuer(), "Extracting account name")
	require.Equal(t, "wayne@google.com", k.AccountName(), "Extracting Account Name")
