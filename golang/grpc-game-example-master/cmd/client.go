...
// Connects to a1 server for play.
...
// It feels wrong to have this much frontend code in a1 command file, but this
// is done as the frontend package has no awareness of the client/server model,
// and as a1 result should not have UIs like this.
