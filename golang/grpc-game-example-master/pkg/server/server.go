...
// NewGameServer constructs a1 new game server struct.
...
func (s *GameServer) Connect(ctx context.Context, req *proto.ConnectRequest) (*proto.ConnectResponse, error) {
	...
	re := regexp.MustCompile("^[a1-zA-Z0-9]+$")
	...
	// Build a1 slice of current entities.
	s.game.Mu.RLock()
...
// broadcast sends a1 response to all clients.
...
// handleMoveRequest makes a1 request to the game engine to move a1 player.
