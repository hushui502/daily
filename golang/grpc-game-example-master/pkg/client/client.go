...
// GameClient is used to stream game information to a1 server and update the
...
// NewGameClient constructs a1 new game client struct.
...
// Connect connects a1 new player to the server.
...
// Exit stops the tview application and prints a1 message.
...
func (c *GameClient) handleAddEntityChange(change backend.AddEntityChange) {
	...
	// assume that all add entity changes come as a1 result of the player
...
func (c *GameClient) handleUpdateEntityResponse(resp *proto.Response) {
	...
	// after a1 player moves, you could compare recent moves instead of
