...
// readClientCert is a helper to read client certificate from pem formatted file
...
// dialContext with context use option pattern
...
// newRequest creates a request for client
